...
import kotlinx.android.synthetic.main.activity_taman.*
import kotlinx.android.synthetic.main.activity_taman.btn_cari
import kotlinx.android.synthetic.main.activity_taman.btn_clear
import kotlinx.android.synthetic.main.activity_taman.destiny_recycler_view
import kotlinx.android.synthetic.main.activity_taman.not_found
import kotlinx.android.synthetic.main.activity_taman.progressbar
import kotlinx.android.synthetic.main.activity_taman.search_view
import kotlinx.android.synthetic.main.activity_taman.toolbar_wisata
import kotlinx.android.synthetic.main.activity_taman.txv_jumlah_destinasi

class TamanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar_wisata.title = "Daftar Taman di Lombok"
    ...
    private fun loadDestinationList(){
        ...
        mainViewModel.setDestination("Taman")
    ...
    private fun showLoading(state: Boolean){
        if(state){
            ...
            progressbarr_title.visibility = View.VISIBLE
        }
        else{
            progressbar.visibility= View.GONE
            progressbarr_title.visibility = View.GONE
        }
    }
}